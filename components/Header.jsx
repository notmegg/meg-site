...
const Header = () => {
  return (
    <div id="header" className="flex flex-col mt-20  xl:mt-28 xl:flex-row w-screen h-full">
      <div className=" w-full text-center px-10 xl:w-1/2 xl:text-left xl:pl-28 text-white">
        ...
        <h1 className=" bg-gradient-to-r from-orange1 to-orange3 text-4xl xl:text-5xl py-2 font-extrabold text-transparent bg-clip-text">
          I'm Meghana
        </h1>
        ...
        <div className=" text-2xl flex justify-center xl:justify-start gap-14 xl:pl-20 xl:gap-24 text-orange-200 mt-10">
          <a href="meghanaps.contact@gmail.com" target="_blank">
          <span
            className=" w-12 h-9
          ...
          <a href="https://www.linkedin.com/in/meghapshetty/" target="_blank">
          <span
            className=" w-12 h-9
           rounded-full hover:text-orange2 hover:translate-y-2 transition-all duration-300"
          >
          ...
          <a href="https://github.com/notmegg" target="_blank">
          <span
            className=" w-12 h-9
           rounded-full hover:text-orange2 hover:translate-y-2 transition-all duration-300"
          >
